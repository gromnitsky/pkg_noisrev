...
program that ships with FreeBSD. Consider the example from vitalized
...
pkg_noisrev also adds filtering to the output, thus you can only see out
of sync packages, for example. If you are a portmaster user, you may
like <tt>--likeportmaster</tt> option (I do!).
